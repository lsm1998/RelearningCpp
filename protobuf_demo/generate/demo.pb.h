...
// int32 age = 2;
inline void Hello::clear_age() {
  _impl_.age_ = 0;
}
inline int32_t Hello::_internal_age() const {
  return _impl_.age_;
}
inline int32_t Hello::age() const {
  // @@protoc_insertion_point(field_get:Hello.age)
  return _internal_age();
}
inline void Hello::_internal_set_age(int32_t value) {
  
  _impl_.age_ = value;
}
inline void Hello::set_age(int32_t value) {
  _internal_set_age(value);
  // @@protoc_insertion_point(field_set:Hello.age)
}
